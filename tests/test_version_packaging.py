...
from verlib2.packaging._structures import Infinity, NegativeInfinity
from verlib2.packaging.version import (
    InvalidVersion,
    Version,
    _BaseVersion,
    _VersionReplace,
...
class TestVersion:
    ...
    def test_invalid_versions_new_python(self) -> None:
        is_old_python = (
            True
        ...
        if is_old_python:
            pytest.skip("Test does not work on older Python versions")  # ty: ignore[too-many-positional-arguments, unused-ignore-comment, unused-ignore-comment]
    ...
    def test_version_pre(self, version: str, pre: Optional[Tuple[str, int]]) -> None:
...
def reset_version_parts(version: Version, **kwargs: typing.Any) -> None:  # noqa: ANN401
    ...
    internal_version = version._version  # ty: ignore[deprecated]
    ...
    version._version = type(internal_version)(**parts)  # ty: ignore[deprecated]
...
def test_deprecated__version() -> None:
    ...
    with pytest.warns(DeprecationWarning, match="is private"):
        assert v._version.release == (1, 2, 3)  # ty: ignore[deprecated]
...
_PACKAGING_25_0_PICKLE_V1_2_3 = (
    b"\x80\x04\x95\xc8\x00\x00\x00\x00\x00\x00\x00\x8c\x19verlib2.packaging.version"
    b"\x94\x8c\x07Version\x94\x93\x94)\x81\x94}\x94(\x8c\x08_version\x94h\x00\x8c"
    b"\x08_Version\x94\x93\x94(K\x00K\x01K\x02K\x03\x87\x94NNNNt\x94\x81\x94\x8c"
    b"\x04_key\x94(K\x00K\x01K\x02K\x03\x87\x94\x8c\x1dverlib2.packaging._structures"
    b"\x94\x8c\x0cInfinityType\x94\x93\x94)\x81\x94h\r\x8c\x14NegativeInfinityType"
    b"\x94\x93\x94)\x81\x94h\x10h\x13t\x94ub."
)

_PACKAGING_25_0_PICKLE_V2_0A1 = (
    b"\x80\x04\x95\xc9\x00\x00\x00\x00\x00\x00\x00\x8c\x19verlib2.packaging.version"
    b"\x94\x8c\x07Version\x94\x93\x94)\x81\x94}\x94(\x8c\x08_version\x94h\x00\x8c"
    b"\x08_Version\x94\x93\x94(K\x00K\x02K\x00\x86\x94N\x8c\x01a\x94K\x01\x86\x94"
    b"NNt\x94\x81\x94\x8c\x04_key\x94(K\x00K\x02\x85\x94h\n\x8c\x1d"
    b"verlib2.packaging._structures\x94\x8c\x14NegativeInfinityType\x94\x93\x94)"
    b"\x81\x94h\x0f\x8c\x0cInfinityType\x94\x93\x94)\x81\x94h\x12t\x94ub."
)
...
_PACKAGING_26_0_PICKLE_V1_2_3 = (
    b"\x80\x04\x95\x83\x00\x00\x00\x00\x00\x00\x00\x8c\x19verlib2.packaging.version"
    b"\x94\x8c\x07Version\x94\x93\x94)\x81\x94N}\x94(\x8c\x04_dev\x94N\x8c\x06_epoch"
    b"\x94K\x00\x8c\n_key_cache\x94N\x8c\x06_local\x94N\x8c\x05_post\x94N\x8c\x04_pre"
    b"\x94N\x8c\x08_release\x94K\x01K\x02K\x03\x87\x94u\x86\x94b."
)
...
_PACKAGING_26_2_TUPLE_PICKLE_V1E2_3_4A5_POST6_DEV7_ZZZ = (
    b"\x80\x04\x95_\x00\x00\x00\x00\x00\x00\x00\x8c\x19verlib2.packaging.version"
    b"\x94\x8c\x07Version\x94\x93\x94)\x81\x94(K\x01K\x02K\x03K\x04\x87\x94\x8c"
    b"\x01a\x94K\x05\x86\x94\x8c\x04post\x94K\x06\x86\x94\x8c\x03dev\x94K\x07"
    b"\x86\x94\x8c\x03zzz\x94\x85\x94t\x94b."
)
